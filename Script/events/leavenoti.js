...
module.exports.run = async function({ api, event }) {
    ...
    if (event.logMessageData.addedParticipants.some(i => i.userFbId == api.getCurrentUserID())) {
        ...
        const fs = require("fs");
        return api.sendMessage("", event.threadID, () => api.sendMessage({body: `──── ···♡   ∩_∩   ♡···────\n  আসসালামু আলাইকুম  \n╰────  ·♡   ∩_∩   ♡·  ────╯

________________________

𝐓𝐡𝐚𝐧𝐤 𝐲𝐨𝐮 𝐬𝐨 𝐦𝐮𝐜𝐡 𝐟𝐨𝐫 𝐚dd𝐢𝐧𝐠 𝐦𝐞 𝐭𝐨 𝐲𝐨𝐮𝐫 𝐠𝐫𝐨𝐮𝐩-🖤🤗\n\n𝐈 𝐰𝐢𝐥𝐥 𝐚𝐥𝐰𝐚𝐲𝐬 𝐬𝐞𝐫𝐯𝐞 𝐲𝐨𝐮 𝐢𝐧s𝐡a𝐚𝐥𝐥𝐚𝐡 😌❤️-!!
...
`, attachment: fs.createReadStream(__dirname + "/cache/ullash.mp4")} ,threadID));
        ...
        try {
            ...
            (typeof threadData.customJoin == "undefined") ? msg = "╭──── · ··♡  ∩_∩  ♡·· ·────╮\n   আসসালামু আলাইকুম-!!🖤\n╰──── · ··♡  ∩_∩  ♡·· ·────╯ \n\n    ✨🆆🅴🅻🅻 🅲🅾🅼🅴✨ \n\n                ❥𝐍𝐄𝐖~ \n\n        ~🇲‌🇪‌🇲‌🇧‌🇪‌🇷‌~\n\n        [   {name} ]\n\n༆-✿ আপনাকে আমাদের࿐\n\n{threadName}\n\n🌺✨!!—এর পক্ষ-থেকে-!!✨🌺\n\n❤️🫰_ভালোবাস_অভিরাম_🫰❤️\n\n༆-✿আপনি_এই_গ্রুপের {soThanhVien} নং মেম্বার࿐\n\n╭──── · ··♡  ∩_∩  ♡·· ·────╮\n  🌸  ♡  ∩ SHIFAT ∩  ♡  🌸\n╰──── · ··♡  ∩_∩  ♡·· · ────╯" : msg = threadData.customJoin;
            msg = msg
